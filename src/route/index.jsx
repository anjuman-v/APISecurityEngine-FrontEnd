...
//Admin
import AddUser from "../Authenticated/admin/add-user/AddUser"
import AdminDashboard from "../Authenticated/admin/dashboard/Dashboard"
import EditUser from "../Authenticated/admin/edit-user/EditUser"
import Users from "../Authenticated/admin/users/Users"

// User
import Agents from "../Authenticated/User/agents/Agents"
import Alerts from "../Authenticated/User/alerts/Alerts"
import ApiEndPoints from "../Authenticated/User/apiEndpoints/ApiEndPoints"
import ApiSpecifications from "../Authenticated/User/apiSpecifications/ApiSpecifications"

import Hosts from "../Authenticated/User/hosts/Hosts"
import PerformQuickScans from "../Authenticated/User/performQuickScans/PerformQuickScans"
import PiiData from "../Authenticated/User/piiData/PiiData"

import QuickScanTablePage from "../Authenticated/User/quickScans/QuickScanTablePage"
import QuickScanDetailPage from "../Authenticated/User/quickScans/QuickScansDetailPage"
import StartQuickScanpage from "../Authenticated/User/quickScans/StartQuickScanpage"
import Setting from "../Authenticated/User/settings/Setting"
import Vulnerabilities from "../Authenticated/User/vulnerabilities/Vulnerabilities"
...
export const routes = [
        ...
        { path: "/quick-scan-table-page/:layout/", Component : QuickScanTablePage},
        { path: "/quick-scan-detail-page/:layout/", Component : QuickScanDetailPage},
        { path: "/start-quick-scan-page/:layout/", Component : StartQuickScanpage},
        { path: "/agents ", Component : Agents},
        { path: "/hosts", Component : Hosts},
        { path: "/api-endpoints", Component : ApiEndPoints},
        { path: "/alerts", Component : Alerts},
        { path: "/pii-data", Component : PiiData},
        { path: "/settings", Component : Setting},
        { path: "/perform-quick-scans", Component : PerformQuickScans},
        { path: "/vulnerabilities", Component : Vulnerabilities},
        { path: "/api-specifications", Component : ApiSpecifications},
